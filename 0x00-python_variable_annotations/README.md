...
- mHow you can use type annotations to specify function signatures and variable types
- Duck typing
...
### [10. Duck typing - first element of a sequence #advanced](./100-safe_first_element.py)
...
### [11. More involved type annotations #advanced](./101-safely_get_value.py)
...
### [12. Type Checking #advanced](./102-type_checking.py)
